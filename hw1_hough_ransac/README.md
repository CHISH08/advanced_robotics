...
![Пример входных данных для 2D lidar](images/2d/local_lidar_points_rect_plus_diagonal.png)
![Проекция облака и найденные структуры](images/2d/walls_rect_plus_diagonal.png)
...
![Карта disparity для стереореконструкции](images/3d/disparity_map.png)
![Итоговое 3D облако с разделением ground/obstacles](images/3d/ground_3d_cloud.png)
